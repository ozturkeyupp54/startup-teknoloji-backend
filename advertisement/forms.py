...
class ReklamForm(forms.ModelForm):
    class Meta:
        model = Advertisement
        fields = ['kampanya_basligi', 'kampanya_creator_adi','kampanya_creator_soyadi','sirket_adi', 'reklam_gosterim_yeri','kampanya_baslangic_tarihi', 'advertisement_ust_resmi', 'kampanyanin_websitesinin_linki', 'max_views_per_image']

    widgets = {
        'advertisement_ust_resmi': forms.FileInput(attrs={'accept': 'image/*'}),
